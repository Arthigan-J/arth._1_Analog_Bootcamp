...
N 250 -210 290 -210 {lab=VDD}
N 290 -210 290 -160 {lab=VDD}
...
N 250 -210 250 -190 {lab=VDD}
N 90 -360 220 -360 {lab=VDD}
N 240 -300 310 -300 {lab=#net2}
N 370 -300 430 -300 {lab=VOUT}
N 250 -280 250 -210 {lab=VDD}
N 40 -110 290 -110 {lab=VDD}
N 290 -110 390 -110 {lab=VDD}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 340 -300 3 0 {name=C1 model=cap_mim_m3_1 W=50 L=10 MF=1 spiceprefix=X}
