...
C {devices/ipin.sym} 500 -300 0 1 {name=p4 lab=VOUT}
C {devices/ipin.sym} 90 -40 0 1 {name=p5 lab=VSS}
C {devices/capa.sym} 460 -270 0 0 {name=C1
m=1
value=1p
footprint=1206
...
C {devices/res.sym} 250 -250 0 0 {name=R1
value=1k
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 460 -240 0 0 {name=l1 lab=GND}
